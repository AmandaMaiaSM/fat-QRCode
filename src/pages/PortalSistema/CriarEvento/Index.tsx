...
export default function CriarEvento() {
  ...
  const publicBaseUrl = import.meta.env.VITE_PUBLIC_BASE_URL as
    | string
    | undefined;
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    localStorage.setItem(
      "meus_eventos",
      JSON.stringify([...eventosSalvos, novoEvento]),
    );
  ...
  return (
    <div className="dashboard-container criar-evento-page">
      <main className="main-content criar-evento-main">
        ...
        <div className="content-wrapper">
          <section className="form-section">
            <form className="create-event-form" onSubmit={handleSubmit}>
              ...
              <hr />
              <h3 style={{ fontSize: "16px", margin: "20px 0 10px" }}>
            ...
            <div className="event-card">
              ...
              <div className="card-body">
                ...
                <div className="card-info">
                  <p>
                    <strong>Data:</strong> {form.date || "--/--/----"}
                  </p>
                  <p>
                    <strong>Hora:</strong> {form.time || "--:--"}
                  </p>
                  <p>
                    <strong>Local:</strong>{" "}
                    {form.location || "Local não definido"}
                  </p>
                </div>
